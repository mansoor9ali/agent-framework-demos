...
from utils import create_deepseek_client, create_dotted_client
from agent_framework.openai import OpenAIChatClient
from agent_framework import ContextProvider, Context, ChatMessage, ChatAgent
...
class AIMemoryExtractor(ContextProvider):
    ...
    def __init__(self, ai_client : OpenAIChatClient, memory_file=MEMORY_FILE):
