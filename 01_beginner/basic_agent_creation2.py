...
from utils import create_azure_openai_client , create_openaichat_client
...
async def non_streaming_example() -> None:
    ...
    async with create_openaichat_client().create_agent(
